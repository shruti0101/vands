...
export default function AboutPage() {
  return (
    <div className="bg-white text-gray-800 mt-10 md:mt-30">

      {/* HERO SECTION */}
      <section className="bg-red-600 text-white py-16 px-6 text-center">
        <h1 className="text-4xl md:text-5xl font-bold mb-4">
          About Us – Vands Engineering Solutions
        </h1>
      ...
      <section className="bg-red-600 text-white py-14 px-6 text-center">
        ...
        <div className="flex flex-wrap justify-center gap-4">
          <a href="tel:+919990730939" className="bg-white text-red-600 px-6 py-3 rounded font-semibold hover:bg-gray-100">
            Call Now 
          </a>
