...
const WhatsAppSticky = () => {
  return (<>
    <a href="https://wa.me/919990730939"
      target="_blank"
      className="bg-green-500 hover:bg-green-600 p-2 rounded-full flex items-center justify-center transition fixed bottom-18 right-4  lg:bottom-20 lg:right-10 z-50 animate-bounce"
    >
